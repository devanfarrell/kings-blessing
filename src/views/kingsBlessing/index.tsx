...
import { selectRedKing, selectRedQueen, selectRedField, selectPresentationOrder } from "redux/slices/kingsBlessing/red";
import { selectBlueKing, selectBlueQueen, selectBlueField } from "redux/slices/kingsBlessing/blue";
...
export default function KingsBlessing() {
  ...
  return (
    <div css={wrapper}>
      ...
      <Fields data={redField} presentationOrder={presentationOrder} team="red" />
      <Center />
      <Fields data={blueField} presentationOrder={presentationOrder} team="blue" />
